/**
 * Horário de funcionamento da org (PBI-26). Client-safe — sem
 * "server-only", sem cookies, sem prisma. Tipos + parser + formatter
 * puros, usados em server components E em BusinessHoursEditor (client).
 *
 ...
 * Usa Intl.DateTimeFormat — sem deps externas, roda em qualquer ambiente.
 */
